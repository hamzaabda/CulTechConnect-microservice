...
export class SidebarComponent implements OnInit, AfterViewInit, OnChanges {
    ...
    interface DecodedToken {
      ...
      this.AuthService.getuserbyemail(sub).subscribe(
        (data) => {
          ...
          console.log(this.useroles)
          console.log(this.useroles.includes('ROLE_SUPERADMIN'))
  ...
  hasRoleAdmin()
  {
    return this.useroles.includes('ROLE_SUPERADMIN');
  }


  filterMenuItemsByRole(): MenuItem[] {
    const userRole = this.connecteduser.role;
